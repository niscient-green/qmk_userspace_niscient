...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [_FKEYS] = LAYOUT(
        _______, KC_F9, KC_F10, KC_F11, KC_F12, KC_SCRL, KC_PSCR, _______, LGUI(KC_UP), _______, _______, _______,
        _______, KC_F5, KC_F6, KC_F7, KC_F8, KC_CAPS, LSFT(KC_PSCR), LSG(KC_LEFT), LGUI(KC_DOWN), LSG(KC_RGHT), _______, _______, 
...
static void render_niscient_logo(void) {
    static const char PROGMEM niscient_logo[] = {// 'lhs logo oled 2022 04 18', 128x20px
...
// Disabled on RH keyboard
// static void render_fox_logo(void) {
//     static const char PROGMEM fox_logo[] = {// 'artic fox oled 2022 04 18', 128x64px
...
static void render_status(void) {
    // Fox logo and version information
    // render_fox_logo();
